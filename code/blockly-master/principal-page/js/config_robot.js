function config_robot() {
  ...
  /*console.log("Laser 1 Activo: " + Laser1_Activo);
  console.log("Laser 1 Rango: " + Laser1_Rango);
  console.log("Laser 1 Precision: " + Laser1_Precision);
  console.log("Laser 2 Activo: " + Laser2_Activo);
  console.log("Laser 2 Rango: " + Laser2_Rango);
  console.log("Laser 2 Precision: " + Laser2_Precision);  

  console.log("Ultrasonido 1 Activo: " + Ultrasonido1_Activo);
  console.log("Ultrasonido 1 Rango: " + Ultrasonido1_Rango);
  console.log("Ultrasonido 1 Precision: " + Ultrasonido1_Precision);
  console.log("Ultrasonido 2 Activo: " + Ultrasonido2_Activo);
  console.log("Ultrasonido 2 Rango: " + Ultrasonido2_Rango);
  console.log("Ultrasonido 2 Precision: " + Ultrasonido2_Precision);

  console.log("Infrarrojo 1 Activo: " + Infrarrojo1_Activo);
  console.log("Infrarrojo 1 Rango: " + Infrarrojo1_Rango);
  console.log("Infrarrojo 1 Precision: " + Infrarrojo1_Precision);
  console.log("Infrarrojo 2 Activo: " + Infrarrojo2_Activo);
  console.log("Infrarrojo 2 Rango: " + Infrarrojo2_Rango);
  console.log("Infrarrojo 2 Precision: " + Infrarrojo2_Precision);

  console.log("Contacto 1 Activo: " + Contacto1_Activo);
  console.log("Contacto 1 Rango: " + Contacto1_Rango);
  console.log("Contacto 1 Precision: " + Contacto1_Precision);
  console.log("Contacto 2 Activo: " + Contacto2_Activo);
  console.log("Contacto 2 Rango: " + Contacto2_Rango);
  console.log("Contacto 2 Precision: " + Contacto2_Precision);

  console.log("Laser2D 1 Activo: " + Laser2d1_Activo);
  console.log("Laser2D 1 Rango: " + Laser2d1_Rango);
  console.log("Laser2D 1 Precision: " + Laser2d1_Precision);
  console.log("Laser2D 2 Activo: " + Laser2d2_Activo);
  console.log("Laser2D 2 Rango: " + Laser2d2_Rango);
  console.log("Laser2D 2 Precision: " + Laser2d2_Precision);*/
