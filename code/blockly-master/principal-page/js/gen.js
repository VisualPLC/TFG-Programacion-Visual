...
Blockly.JavaScript['sensor_laser'] = function(block) {
  ...
  if (Laser[0].children[0].tagName != "Activo") { // Si hay más de un sensor

    if (num_sensor > num_sensores_laser) {  // Si el usuario introduce un nº mayor al nº de sensores que hay
